...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        if state in self.Q.keys():
            ...
            print "THIS STATE is not yet in Q dictionary"
            maxQ = 0.0
        return maxQ
    ...
    def createQ(self, state):
        ...
        if self.learning:
            ...
            if str(state) in self.Q:
                pass
                #print "PRINTING Q: ", self.Q
            else:
                self.Q[str(state)] = {}
                for i in range(len(self.valid_actions)):
                    self.Q[str(state)][self.valid_actions[i]] = 0.0
                #print "Initialize Q: ", self.Q
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            #action = random.choice(self.valid_actions)
            action = np.random.choice( learning_actions, p = weights)
        ###########
        ## TO DO ##
        ###########
